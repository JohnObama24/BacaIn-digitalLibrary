    ...
    <nav class="w-full bg-primary-blue text-white shadow-md relative">
        ...
        <div x-show="openMenu" x-transition
            ...
            <div class="py-2">
                ...
                <a href="{{ route('admin.dashboard') }}" class="block px-6 py-3 hover:bg-gray-100 font-medium">
                    Statistik Data
                </a>

                <a href="{{ route('buku.index') }}" class="block px-6 py-3 hover:bg-gray-100 font-medium">
                    Manajemen Buku
                </a>

                <a href="{{ route('kategori.index') }}" class="block px-6 py-3 hover:bg-gray-100 font-medium">
                    Kategori Buku
                </a>
                ...
                <a href="{{ route('peminjaman.index') }}" class="block px-6 py-3 hover:bg-gray-100 font-medium">

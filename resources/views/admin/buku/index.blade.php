                            ...
                            <tr class="hover:bg-gray-50 transition book-row">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center justify-center space-x-2">
                                        <button type="button" @click="$dispatch('open-modal', 'edit-book-{{ $book->id }}')" class="px-3 py-1.5 bg-yellow-500 text-white rounded hover:bg-yellow-600 transition text-sm font-medium">
                                            Edit
                                        </button>
